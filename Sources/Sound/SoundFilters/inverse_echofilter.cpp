...
CL_InverseEchoFilter::CL_InverseEchoFilter(int buffer_size) : CL_SoundFilter( new CL_InverseEchoFilterProvider(buffer_size))
{
}
...
{
	return static_cast <CL_InverseEchoFilterProvider *> (CL_SoundFilter::get_provider());
}
