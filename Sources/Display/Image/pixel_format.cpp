...
: type(pixelformat_rgba), colorkey_enabled(false), colorkey(0), red_mask(0),
  green_mask(0), blue_mask(0), alpha_mask(0), depth(0)
{
}
...
CL_PixelFormat CL_PixelFormat::argb8888(32, 0x00ff0000, 0x0000ff00, 0x000000ff, 0xff000000);
