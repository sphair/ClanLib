...
public:
	...
	void on_point_offset_changed(GraphicContext_State *state);
	void on_line_offset_changed(GraphicContext_State *state);
	void on_polygon_offset_changed(GraphicContext_State *state);
	void on_offset_factor_changed(GraphicContext_State *state);
	void on_offset_units_changed(GraphicContext_State *state);
