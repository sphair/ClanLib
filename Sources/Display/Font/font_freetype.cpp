...
CL_Font_Freetype::CL_Font_Freetype(
	const CL_StringRef &typeface_name, int height) : CL_Font( new CL_FontProvider_Freetype())
{
	get_provider()->load_font(typeface_name, height);
}

CL_Font_Freetype::CL_Font_Freetype(
	const CL_FontDescription &desc) : CL_Font( new CL_FontProvider_Freetype())
{
...
CL_FontProvider_Freetype *CL_Font_Freetype::get_provider()
{
