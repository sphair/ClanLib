...
class CL_SpriteRenderBatch : CL_RenderBatcher
{
public:
	CL_SpriteRenderBatch();
...
private:
	...
	inline void to_sprite_vertex(const CL_Surface_DrawParams1 *params, int index, CL_SpriteRenderBatch::SpriteVertex &v, int texindex) const;
