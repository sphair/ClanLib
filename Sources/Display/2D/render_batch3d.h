...
class CL_RenderBatch3D : public CL_RenderBatcherSprite
{
public:
	CL_RenderBatch3D();
...
private:
	...
	inline void to_sprite_vertex(const CL_Surface_DrawParams1 *params, int index, CL_RenderBatch3D::SpriteVertex &v, int texindex) const;
