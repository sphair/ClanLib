...
class CL_InputDeviceProvider_Win32Mouse : public CL_InputDeviceProvider
{
/// \name Construction
/// \{

public:
	CL_InputDeviceProvider_Win32Mouse(CL_Win32Window *window);

	~CL_InputDeviceProvider_Win32Mouse();
