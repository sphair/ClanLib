...
public:
	CursorProvider_Win32(const SpriteDescription &sprite_description, const Point &hotspot);
...
private:
	static HCURSOR create_cursor(const SpriteDescription &sprite_description, const Point &hotspot);
	...
	static DataBuffer create_ani_file(const SpriteDescription &sprite_description, const Point &hotspot);
