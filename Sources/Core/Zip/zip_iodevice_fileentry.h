...
class CL_ZipIODevice_FileEntry : public CL_IODeviceProvider
{
/// \name Construction
/// \{

public:
	CL_ZipIODevice_FileEntry(CL_IODevice iodevice, const CL_ZipFileEntry &entry);

	~CL_ZipIODevice_FileEntry();
