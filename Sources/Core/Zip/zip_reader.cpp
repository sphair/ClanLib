...
public:
	...
	cl_int64 deflate_read(void *data, cl_int64 size, bool read_all);
...
cl_int64 CL_ZipReader::get_compressed_size() const
{
	return impl->local_header.compressed_size;
}

cl_int64 CL_ZipReader::get_uncompressed_size() const
{
	return impl->local_header.uncompressed_size;
}

void CL_ZipReader::set_data_descriptor_data(cl_int64 compressed_size, cl_int64 uncompressed_size, cl_uint32 crc32)
{
...
cl_int64 CL_ZipReader::read_file_data(void *data, cl_int64 size, bool read_all)
{
	if (impl->zstream_open)
	{
...
cl_int64 CL_ZipReader_Impl::deflate_read(void *data, cl_int64 size, bool read_all)
{
