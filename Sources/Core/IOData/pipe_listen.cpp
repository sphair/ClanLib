...
/////////////////////////////////////////////////////////////////////////////
// PipeListen Attributes:

#ifdef WIN32
HANDLE PipeListen::get_handle() const
{
	return impl->handle;
}
#else
int PipeListen::get_handle() const
{
	return impl->handle;
}
#endif
...
/////////////////////////////////////////////////////////////////////////////
// PipeListen Operations:

Event PipeListen::begin_accept()
{
	return impl->begin_accept();
}

PipeConnection PipeListen::complete_accept()
{
	return impl->complete_accept();
}

void PipeListen::cancel_accept()
{
	impl->cancel_accept();
}

PipeConnection PipeListen::accept()
{
	return impl->accept();
}

/////////////////////////////////////////////////////////////////////////////
// PipeListen Implementation:
