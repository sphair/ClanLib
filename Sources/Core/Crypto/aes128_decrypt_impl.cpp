...
/////////////////////////////////////////////////////////////////////////////
// CL_AES128_Decrypt_Impl Construction:

CL_AES128_Decrypt_Impl::CL_AES128_Decrypt_Impl() : initialisation_vector_set(false), cipher_key_set(false), padding_enabled(true), 	padding_pkcs7(true)
{
	reset();
}

/////////////////////////////////////////////////////////////////////////////
// CL_AES128_Decrypt_Impl Attributes:

CL_DataBuffer CL_AES128_Decrypt_Impl::get_data() const
{
	return databuffer;
}

/////////////////////////////////////////////////////////////////////////////
// CL_AES128_Decrypt_Impl Operations:

void CL_AES128_Decrypt_Impl::reset()
{
	calculated = false;
...
void CL_AES128_Decrypt_Impl::set_iv(const unsigned char iv[16])
{
...
void CL_AES128_Decrypt_Impl::set_padding(bool value, bool use_pkcs7)
{
	padding_enabled = value;
	padding_pkcs7 = use_pkcs7;
}

void CL_AES128_Decrypt_Impl::set_key(const unsigned char key[16])
{
	cipher_key_set = true;
...
void CL_AES128_Decrypt_Impl::add(const void *_data, int size)
{
	if (calculated)
		reset();
...
bool CL_AES128_Decrypt_Impl::calculate()
{
	if (calculated)
		reset();
...
/////////////////////////////////////////////////////////////////////////////
// CL_AES128_Decrypt_Impl Implementation:

void CL_AES128_Decrypt_Impl::process_chunk()
{
