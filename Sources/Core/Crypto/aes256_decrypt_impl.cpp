...
/////////////////////////////////////////////////////////////////////////////
// CL_AES256_Decrypt_Impl Construction:

CL_AES256_Decrypt_Impl::CL_AES256_Decrypt_Impl() : initialisation_vector_set(false), cipher_key_set(false), padding_enabled(true), 	padding_pkcs7(true)
{
	reset();
}

/////////////////////////////////////////////////////////////////////////////
// CL_AES256_Decrypt_Impl Attributes:

CL_DataBuffer CL_AES256_Decrypt_Impl::get_data() const
{
	return databuffer;
}

/////////////////////////////////////////////////////////////////////////////
// CL_AES256_Decrypt_Impl Operations:

void CL_AES256_Decrypt_Impl::reset()
{
	calculated = false;
...
void CL_AES256_Decrypt_Impl::set_iv(const unsigned char iv[16])
{
...
void CL_AES256_Decrypt_Impl::set_padding(bool value, bool use_pkcs7)
{
	padding_enabled = value;
	padding_pkcs7 = use_pkcs7;
}

void CL_AES256_Decrypt_Impl::set_key(const unsigned char key[32])
{
	cipher_key_set = true;
...
void CL_AES256_Decrypt_Impl::add(const void *_data, int size)
{
	if (calculated)
		reset();
...
bool CL_AES256_Decrypt_Impl::calculate()
{
	if (calculated)
		reset();
...
/////////////////////////////////////////////////////////////////////////////
// CL_AES256_Decrypt_Impl Implementation:

void CL_AES256_Decrypt_Impl::process_chunk()
{
	const cl_ubyte32 *key_expanded_ptr = key_expanded;

	cl_ubyte32 chunk1 = get_word(chunk);
	cl_ubyte32 chunk2 = get_word(chunk + 4);
	cl_ubyte32 chunk3 = get_word(chunk + 8);
	cl_ubyte32 chunk4 = get_word(chunk + 12);

	cl_ubyte32 s0 = chunk1 ^ key_expanded_ptr[0];
	cl_ubyte32 s1 = chunk2 ^ key_expanded_ptr[1];
	cl_ubyte32 s2 = chunk3 ^ key_expanded_ptr[2];
	cl_ubyte32 s3 = chunk4 ^ key_expanded_ptr[3];
