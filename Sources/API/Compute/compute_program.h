...
public:
	...
	/// \brief Constructs a compute program
	///
	/// \param cc = Compute context the program will be used in
	/// \param source_code = Program source code
...
/// \{
private:
	std::shared_ptr<ComputeProgram_Impl> impl;
