...
/// \brief <p>ClanLib perl compatible regular expression library.</p>
//! Global=RegExp
...
#pragma managed(pop)
		...
		#error Your application is set to link with the single-threaded version of the run-time library. Go to project settings, in the C++ section, and change it to multi-threaded.
			...
			#pragma comment(lib, "pcre-dll.lib")
		#elif defined(_DLL)
			...
			#pragma comment(lib, "pcre-dll-debug.lib")
		#elif defined(_DLL)
