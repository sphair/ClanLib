...
public:
	...
	CursorDescription(GraphicContext &gc, const std::string &resource_id, XMLResourceDocument *resources, const ImageImportDescription &import_desc = ImageImportDescription ());
...
/// \{
private:
	/// \brief CursorDescription implementation.
