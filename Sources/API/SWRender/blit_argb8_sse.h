...
inline void BlitARGB8SSE::copy_pixels(unsigned int *dest, const unsigned int *src)
{
	__m128i src0;
...
inline void BlitARGB8SSE::load_pixel(__m128i &xmm, const unsigned int &pixel)
{
	xmm = _mm_cvtsi32_si128(pixel);
	xmm = _mm_unpacklo_epi8(xmm, _mm_setzero_si128());
}

inline void BlitARGB8SSE::load_pixels(__m128i &xmm, const unsigned int *pixels)
{
	xmm = _mm_loadl_epi64((const __m128i *) pixels);
	xmm = _mm_unpacklo_epi8(xmm, _mm_setzero_si128());
}

inline void BlitARGB8SSE::load_pixels(__m128i &xmm, const unsigned int &p1, unsigned int &p2)
{
	xmm = _mm_set_epi32(0, 0, p2, p1);
	xmm = _mm_unpacklo_epi8(xmm, _mm_setzero_si128());
}

inline void BlitARGB8SSE::load_pixel_linear(__m128i &xmm, const unsigned int &pixel1, const unsigned int &pixel2, const unsigned int &pixel3, const unsigned int &pixel4, unsigned int ifracx, unsigned int ifracy)
{
...
inline void BlitARGB8SSE::set_one(__m128i &xmm)
{
	xmm =  _mm_set1_epi16(0x0100);
}

inline void BlitARGB8SSE::set_half(__m128i &xmm)
{
	xmm =  _mm_set1_epi16(0x007f);
}

inline void BlitARGB8SSE::set_color(__m128i &xmm, unsigned short red, unsigned short green, unsigned short blue, unsigned short alpha)
{
	xmm = _mm_set_epi16(alpha, red, green, blue, alpha, red, green, blue);
}

inline void BlitARGB8SSE::set_color(__m128i &xmm, unsigned short r1, unsigned short g1, unsigned short b1, unsigned short a1, unsigned short r2, unsigned short g2, unsigned short b2, unsigned short a2)
{
	xmm = _mm_set_epi16(a2, r2, g2, b2, a1, r1, g1, b1);
}

#ifdef _MSC_VER
inline void BlitARGB8SSE::multiply_color(__m128i &src, __m128i &primcolor)
{
...
inline void BlitARGB8SSE::blend_normal(__m128i &dest, __m128i &src, __m128i &one, __m128i &half)
{
...
inline void BlitARGB8SSE::blend_premultiplied(__m128i &dest, __m128i &src, __m128i &one, __m128i &half)
{
	__m128i src_alpha, invsrc_alpha;
...
inline void BlitARGB8SSE::blend_lcd(__m128i &dest, __m128i &src, __m128i &one, __m128i &half, __m128i &color)
{
	__m128i invsrc;
...
inline void BlitARGB8SSE::store_pixel(unsigned int &pixel, __m128i &xmm)
{
	xmm = _mm_packus_epi16(xmm, _mm_setzero_si128());
	pixel = _mm_cvtsi128_si32(xmm);
}

inline void BlitARGB8SSE::store_pixels(unsigned int *pixels, __m128i &xmm)
{
	xmm = _mm_packus_epi16(xmm, _mm_setzero_si128());
	_mm_storel_epi64((__m128i *) pixels, xmm);
}

inline void BlitARGB8SSE::pixels_to_channels(__m128i &red, __m128i &green, __m128i &blue, __m128i &alpha, const __m128i &src0, const __m128i &src1)
{
...
inline void BlitARGB8SSE::channels_to_pixels(__m128i &dest0, __m128i &dest1, __m128i &red, __m128i &green, __m128i &blue, __m128i &alpha)
{
	__m128i alpha_mask = _mm_set1_epi32(0xff000000);
	__m128i red_mask = _mm_set1_epi32(0x00ff0000);
	__m128i green_mask = _mm_set1_epi32(0x0000ff00);
...
// Sadly it seems that the Visual C++ 2008 compiler is unable to optimize BlitARGB8SSE::texture_repeat properly
