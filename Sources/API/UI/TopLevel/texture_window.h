...
namespace clan
{
	...
	protected:
		...
		void present_popup(const Pointf &pos, const std::shared_ptr<View> &popup) override;
		void dismiss_popup() override;

		void present_modal(const std::string &title, const std::shared_ptr<View> &modal) override;
