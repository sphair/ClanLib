...
/// \brief LegacyGL Graphic Context
///
/// \xmlonly !group=GL1/Display! !header=gl1.h! \endxmlonly
class CL_API_LegacyGL GraphicContext_LegacyGL : public GraphicContext
{
//!Construction
public:
	// \brief Create a null instance
	GraphicContext_LegacyGL() {}

	/// \brief Create a LegacyGL specific graphics context
	GraphicContext_LegacyGL(GraphicContext &gc);
...
//!Implementation
private:
	std::shared_ptr<GraphicContext_LegacyGL_Impl> impl;
};
