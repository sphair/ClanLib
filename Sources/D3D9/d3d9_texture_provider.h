...
class CL_D3D9TextureProvider : public CL_TextureProvider
{
/// \name Construction
/// \{

public:
	CL_D3D9TextureProvider(CL_D3D9GraphicContextProvider *gc, CL_TextureDimensions texture_dimensions);

	~CL_D3D9TextureProvider();
