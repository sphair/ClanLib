...
CL_NetComputer &CL_NetObject_Client::get_server()
{
	return impl->server;
}
...
void CL_NetObject_Client::send(int msg_type, const CL_DataBuffer &message)
{
...
CL_Signal_v1<CL_DataBuffer &> &CL_NetObject_Client::sig_received_message(int msg_type)
{
