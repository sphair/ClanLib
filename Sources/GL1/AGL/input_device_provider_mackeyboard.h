...
class InputDeviceProvider_MacKeyboard : public InputDeviceProvider
{
/// \name Construction
/// \{

public:
	InputDeviceProvider_MacKeyboard(CL_GL1WindowProvider_AGL *window);

	~InputDeviceProvider_MacKeyboard();
