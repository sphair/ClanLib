...
class InputDeviceProvider_MacMouse : public InputDeviceProvider
{
/// \name Construction
/// \{

public:
	InputDeviceProvider_MacMouse(CL_GL1WindowProvider_AGL *window);

	~InputDeviceProvider_MacMouse();
...
public:
	...
	InputDevice::Type get_type() const { return InputDevice::mouse; }
