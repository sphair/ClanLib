...
class CL_GL1WindowProvider_AGL;

class CL_InputDeviceProvider_MacMouse : public CL_InputDeviceProvider
{
/// \name Construction
/// \{

public:
	CL_InputDeviceProvider_MacMouse(CL_GL1WindowProvider_AGL *window);

	~CL_InputDeviceProvider_MacMouse();

	void destroy() { /* do not delete this here. Handled by CL_GL1WindowProvider_AGL. */ }
...
public:
	...
	CL_InputDevice::Type get_type() const { return CL_InputDevice::mouse; }
...
private:
	...
	friend class CL_GL1WindowProvider_AGL;
/// \}
};
