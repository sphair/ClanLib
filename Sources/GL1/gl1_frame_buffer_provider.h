...
class CL_API_DISPLAY CL_GL1FrameBufferProvider : public CL_FrameBufferProvider, CL_DisposableObject
{
/// \name Construction
/// \{

public:
	CL_GL1FrameBufferProvider(CL_GL1GraphicContextProvider *gc_provider);

	~CL_GL1FrameBufferProvider();
...
private:
	...
	CL_GL1TextureProvider *selected_texture_provider;
