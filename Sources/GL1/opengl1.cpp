...
bool CL_GL1::from_opengl_pixelformat(CLenum format, CLenum type, CL_PixelFormat &pf)
{
...
bool CL_GL1::to_opengl_pixelformat(const CL_PixelFormat &pf, CLenum &format, CLenum &type)
{
/*
	// Types:
	CL_UNSIGNED_BYTE
