...
/////////////////////////////////////////////////////////////////////////////
// GL1FrameBufferProvider Construction:
...
void GL1FrameBufferProvider::set_active() const
{
	pbuffer.set_active();
...
{
	throw Exception("GL1 RenderBuffers are not supported");
}
...
void GL1FrameBufferProvider::sync_pbuffer()
{
	...
	cl1LoadIdentity();
	cl1MultMatrixf(Mat4f::ortho_2d(0.0f, (float)surface_size.width, 0.0f, (float)surface_size.height, handed_right, clip_negative_positive_w));
