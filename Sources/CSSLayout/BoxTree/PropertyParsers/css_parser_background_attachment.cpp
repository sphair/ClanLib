...
std::vector<CL_String> CL_CSSParserBackgroundAttachment::get_names()
{
...
void CL_CSSParserBackgroundAttachment::parse(CL_CSSBoxProperties &properties, const CL_String &name, const std::vector<CL_CSSToken> &tokens, std::map<CL_String, CL_CSSBoxProperty *> *out_change_set)
{
	size_t pos = 0;
