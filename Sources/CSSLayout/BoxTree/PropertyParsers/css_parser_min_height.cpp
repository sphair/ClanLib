...
std::vector<CL_String> CL_CSSParserMinHeight::get_names()
{
...
void CL_CSSParserMinHeight::parse(CL_CSSBoxProperties &properties, const CL_String &name, const std::vector<CL_CSSToken> &tokens)
{
	size_t pos = 0;
