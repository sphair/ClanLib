...
void CL_CSSBoxProperties::compute(const CL_CSSBoxProperties *parent, CL_CSSResourceCache *layout)
{
	...
	if (parent)
	{
		...
		CL_CSSBoxRight::compute(left, right, parent, layout, em_size, ex_size, position, is_containing_block_ltr);
		CL_CSSBoxBottom::compute(top, bottom, parent, layout, em_size, ex_size, position);
	...
	else
	{
		...
		CL_CSSBoxRight::compute(left, right, 0, layout, em_size, ex_size, position, is_containing_block_ltr);
		CL_CSSBoxBottom::compute(top, bottom, 0, layout, em_size, ex_size, position);
