...
CL_CSSBoxMinHeight::CL_CSSBoxMinHeight()
: type(type_length), length(0, CL_CSSBoxLength::type_px), percentage(0.0f)
{
}

void CL_CSSBoxMinHeight::compute(const CL_CSSBoxMinHeight *parent, CL_CSSResourceCache *layout, float em_size, float ex_size)
{
...
CL_String CL_CSSBoxMinHeight::to_string() const
{
	switch (type)
	{
	default:
