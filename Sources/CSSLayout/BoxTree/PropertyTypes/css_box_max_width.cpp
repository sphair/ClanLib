...
void CL_CSSBoxMaxWidth::compute(const CL_CSSBoxMaxWidth *parent, CL_CSSResourceCache *layout, float em_size, float ex_size)
{
...
CL_String CL_CSSBoxMaxWidth::to_string() const
{
	switch (type)
	{
	default:
