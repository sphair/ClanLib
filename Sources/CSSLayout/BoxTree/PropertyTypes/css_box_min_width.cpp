...
void CL_CSSBoxMinWidth::compute(const CL_CSSBoxMinWidth *parent, CL_CSSResourceCache *layout, float em_size, float ex_size)
{
...
CL_String CL_CSSBoxMinWidth::to_string() const
{
	switch (type)
	{
	default:
