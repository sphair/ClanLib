...
class CSSInlineLayoutCreateLinebreakOpportunities : public CSSInlineGeneratedBoxVisitor
{
public:
	CSSInlineLayoutCreateLinebreakOpportunities(std::vector<CSSInlineLineBreakOpportunity> &linebreak_opportunities);
