...
CSSInlineLayoutRenderLayerNonInline::CSSInlineLayoutRenderLayerNonInline(CSSLayoutGraphics *graphics, CSSResourceCache *resources, CSSStackingContext *stacking_context)
: graphics(graphics), resources(resources), stacking_context(stacking_context)
{
}

bool CSSInlineLayoutRenderLayerNonInline::node(CSSInlineGeneratedBox *cur)
{
	if (cur->layout_node)
	{
