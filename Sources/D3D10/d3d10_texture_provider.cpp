...
void CL_D3D10TextureProvider::create(int width, int height, CL_TextureFormat internal_format, int depth)
{
}

CL_PixelBuffer CL_D3D10TextureProvider::get_pixeldata(CL_PixelFormat &format, int level) const
{
