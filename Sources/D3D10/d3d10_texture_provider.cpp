...
void CL_D3D10TextureProvider::create(int width, int height, int format, int depth)
{
}

CL_PixelBuffer CL_D3D10TextureProvider::get_pixeldata(CL_PixelFormat &format, int level)
{
	return CL_PixelBuffer();
}

void CL_D3D10TextureProvider::set_image(CL_PixelBuffer &image, int level, int format)
{
}
...
void CL_D3D10TextureProvider::set_generate_mipmap(bool generate_mipmap)
{
}
...
void CL_D3D10TextureProvider::set_depth_mode(CL_TextureDepthMode depth_mode)
{
}
