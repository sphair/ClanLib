...
void CL_SWRenderProgramObjectProvider::set_uniform1i(const CL_StringRef &name, int)
{
}

void CL_SWRenderProgramObjectProvider::set_uniform2i(const CL_StringRef &name, int, int)
{
}

void CL_SWRenderProgramObjectProvider::set_uniform3i(const CL_StringRef &name, int, int, int)
{
}

void CL_SWRenderProgramObjectProvider::set_uniform4i(const CL_StringRef &name, int, int, int, int)
{
}
...
void CL_SWRenderProgramObjectProvider::set_uniform1f(const CL_StringRef &name, float)
{
}

void CL_SWRenderProgramObjectProvider::set_uniform2f(const CL_StringRef &name, float, float)
{
}

void CL_SWRenderProgramObjectProvider::set_uniform3f(const CL_StringRef &name, float, float, float)
{
}

void CL_SWRenderProgramObjectProvider::set_uniform4f(const CL_StringRef &name, float, float, float, float)
{
}
