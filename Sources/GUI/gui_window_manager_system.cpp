...
CL_GUIWindowManagerSystem::CL_GUIWindowManagerSystem() : CL_GUIWindowManager( new CL_GUIWindowManagerProvider_System())
{
}
...
CL_GUIWindowManagerProvider_System *CL_GUIWindowManagerSystem::get_provider() const
{
