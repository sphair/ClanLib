...
#define RTREE_QUAL RTreeRoot<DATATYPE, ELEMTYPE, NUMDIMS, ELEMTYPEREAL, TMAXNODES, TMINNODES>
...
public:
  ...
  private:
    ...
    friend class RTreeRoot; // Allow hiding of non-public functions while allowing manipulation by logical owner
  };
