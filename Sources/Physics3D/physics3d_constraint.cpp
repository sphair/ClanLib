...
Physics3DConstraint Physics3DConstraint::point_to_point(Physics3DWorld &world, const Physics3DObject &a, const Vec3f &pivot_in_a)
{
	...
	world.impl->dynamics_world->addConstraint(constraint.impl->constraint.get());

	return constraint;
}

Physics3DConstraint Physics3DConstraint::point_to_point(Physics3DWorld &world, const Physics3DObject &a, const Physics3DObject &b, const Vec3f &pivot_in_a, const Vec3f &pivot_in_b)
{
	btRigidBody &body_a = *btRigidBody::upcast(a.impl->object.get());
...
Physics3DConstraint Physics3DConstraint::hinge(Physics3DWorld &world, const Physics3DObject &a, const Vec3f &pivot_in_a, const Quaternionf &axis_in_a, bool use_reference_frame_a)
{
	btRigidBody &body_a = *btRigidBody::upcast(a.impl->object.get());
...
Physics3DConstraint Physics3DConstraint::hinge(Physics3DWorld &world, const Physics3DObject &a, const Physics3DObject &b, const Vec3f &pivot_in_a, const Vec3f &pivot_in_b, const Quaternionf &axis_in_a, const Quaternionf &axis_in_b, bool use_reference_frame_a)
{
	btRigidBody &body_a = *btRigidBody::upcast(a.impl->object.get());
	btRigidBody &body_b = *btRigidBody::upcast(b.impl->object.get());
...
Physics3DConstraint Physics3DConstraint::slider(Physics3DWorld &world, const Physics3DObject &a, const Physics3DObject &b, const Vec3f &pivot_in_a, const Vec3f &pivot_in_b, const Quaternionf &axis_in_a, const Quaternionf &axis_in_b, bool use_reference_frame_a)
{
	btRigidBody &body_a = *btRigidBody::upcast(a.impl->object.get());
	btRigidBody &body_b = *btRigidBody::upcast(b.impl->object.get());
...
Physics3DConstraint Physics3DConstraint::cone_twist(Physics3DWorld &world, const Physics3DObject &a, const Vec3f &pivot_in_a, const Quaternionf &axis_in_a)
{
	btRigidBody &body_a = *btRigidBody::upcast(a.impl->object.get());
...
Physics3DConstraint Physics3DConstraint::cone_twist(Physics3DWorld &world, const Physics3DObject &a, const Physics3DObject &b, const Vec3f &pivot_in_a, const Vec3f &pivot_in_b, const Quaternionf &axis_in_a, const Quaternionf &axis_in_b)
{
	btRigidBody &body_a = *btRigidBody::upcast(a.impl->object.get());
	btRigidBody &body_b = *btRigidBody::upcast(b.impl->object.get());
...
Physics3DConstraint Physics3DConstraint::six_degrees_of_freedom(Physics3DWorld &world, const Physics3DObject &a, const Physics3DObject &b, const Vec3f &pivot_in_a, const Vec3f &pivot_in_b, const Quaternionf &axis_in_a, const Quaternionf &axis_in_b, bool use_reference_frame_a)
{
	btRigidBody &body_a = *btRigidBody::upcast(a.impl->object.get());
	btRigidBody &body_b = *btRigidBody::upcast(b.impl->object.get());
