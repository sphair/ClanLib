...
class CL_InputDeviceProvider_SDLMouse : public CL_InputDeviceProvider
{
/// \name Construction
/// \{

public:
	CL_InputDeviceProvider_SDLMouse(CL_SDLWindow *window);

	~CL_InputDeviceProvider_SDLMouse();

	void destroy() { /* do not delete this here. Handled by CL_SDLWindow. */ }
...
public:
	...
	void handle_mouse_move_event(SDL_MouseMotionEvent &event);
	void handle_mouse_input_event(SDL_MouseButtonEvent &event);
