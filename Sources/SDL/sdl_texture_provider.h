...
class CL_SDLTextureProvider : public CL_TextureProvider
{
/// \name Construction
/// \{

public:
	CL_SDLTextureProvider();
...
public:
	...
	CL_TextureFilter get_min_filter() const { return min_filter; };
	CL_TextureFilter get_mag_filter() const { return mag_filter; };
