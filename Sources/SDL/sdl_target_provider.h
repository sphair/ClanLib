...
class CL_SDLTargetProvider : public CL_DisplayTargetProvider
{
/// \name Construction
/// \{

public:
	CL_SDLTargetProvider();
...
private:
	static CL_DisplayMessageQueue_SDL message_queue;

	friend class CL_SDLDisplayWindowProvider;
/// \}
};
