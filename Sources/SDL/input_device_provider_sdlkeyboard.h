...
class CL_InputDeviceProvider_SDLKeyboard : public CL_InputDeviceProvider
{
/// \name Construction
/// \{

public:
	CL_InputDeviceProvider_SDLKeyboard(CL_SDLWindow *window);

	~CL_InputDeviceProvider_SDLKeyboard();
