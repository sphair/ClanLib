...
class CL_API_DISPLAY CL_CursorProvider_SDL : public CL_CursorProvider
{
/// \name Construction
/// \{

public:
	CL_CursorProvider_SDL(const CL_SpriteDescription &sprite_description, const CL_Point &hotspot);

	~CL_CursorProvider_SDL();
