...
class CL_GDIDisplayWindowProvider;

class CL_GDIGraphicContextProvider : public CL_GraphicContextProvider
{
/// \name Construction
/// \{
public:
	CL_GDIGraphicContextProvider(CL_GDIDisplayWindowProvider *window);
	~CL_GDIGraphicContextProvider();
/// \}
...
#endif
	CL_PixelPipeline *get_pixel_canvas() const { return pixel_canvas; }
/// \}
