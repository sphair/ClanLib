...
Orientation Orientation::axis_angle(float angle, const Vec3f &axis)
{
	...
	float half_angle_radians = angle * PI / 360.0f;
	Orientation o;
...
{
	float half_angle_x_radians = angle_x * PI / 360.0f;
	float half_angle_y_radians = angle_y * PI / 360.0f;
	float half_angle_z_radians = angle_z * PI / 360.0f;
