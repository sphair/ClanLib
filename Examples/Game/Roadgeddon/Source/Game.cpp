...
{	
	...
	cc.connect(window.sig_window_close(), Callback<void()>(this,&Game::on_quit));
	cc.connect(window.get_ic().get_keyboard().sig_key_down(), Callback<void()>(this,&Game::on_key_down));
	cc.connect(window.get_ic().get_keyboard().sig_key_up(), Callback<void()>(this,&Game::on_key_up));
	cc.connect(window.get_ic().get_mouse().sig_pointer_move(), Callback<void()>(this,&Game::on_pointer_move));
	cc.connect(window.get_ic().get_mouse().sig_key_down(), Callback<void()>(this,&Game::on_pointer_down));
	cc.connect(window.get_ic().get_mouse().sig_key_up(), Callback<void()>(this,&Game::on_pointer_up));
