...
{
	func_close() = bind_member(this, &MenuBar::on_close);
	...
	menu_file.insert_item("New").func_clicked() = bind_member(this, &MenuBar::on_item_selected);
	menu_file.insert_item("Open").func_clicked() = bind_member(this, &MenuBar::on_item_selected);
	menu_file.insert_item("Save").func_clicked() = bind_member(this, &MenuBar::on_item_selected);
	clan::PopupMenuItem tux_item = menu_file.insert_item("Tux");
	tux_item.func_clicked() = bind_member(this, &MenuBar::on_item_selected);
	tux_item.set_icon(tux_image);

	menu_file.insert_item("Exit").func_clicked() = bind_member(this, &MenuBar::on_item_selected);
	menubar1->add_menu("File", menu_file);

	menu_edit.insert_item("Undo").func_clicked() = bind_member(this, &MenuBar::on_item_selected);
	clan::PopupMenuItem redo_item = menu_edit.insert_item("Redo");
	redo_item.func_clicked() = bind_member(this, &MenuBar::on_item_selected);
	redo_item.set_enabled(false);
	menu_edit.insert_separator();
	menu_edit.insert_item("Cut").func_clicked() = bind_member(this, &MenuBar::on_item_selected);
	menu_edit.insert_item("Copy").func_clicked() = bind_member(this, &MenuBar::on_item_selected);
	menu_edit.insert_separator();
	item_submenu = menu_edit.insert_item("Submenu");
	item_submenu.func_clicked() = bind_member(this, &MenuBar::on_item_selected);
	menu_edit.insert_separator();
	menu_edit.insert_item("Paste").func_clicked() = bind_member(this, &MenuBar::on_item_selected);
	menu_edit.insert_item("Delete").func_clicked() = bind_member(this, &MenuBar::on_item_selected);
	menu_edit.insert_separator();
	menu_edit.insert_item("Select All").func_clicked() = bind_member(this, &MenuBar::on_item_selected);

	menu_submenu.insert_item("foo").func_clicked() = bind_member(this, &MenuBar::on_item_selected);
	menu_submenu.insert_item("bar").func_clicked() = bind_member(this, &MenuBar::on_item_selected);
	menu_submenu.insert_item("foobar").func_clicked() = bind_member(this, &MenuBar::on_item_selected);
	clan::PopupMenuItem check_item1 = menu_submenu.insert_item("Checkable 1");
	check_item1.func_clicked() = bind_member(this, &MenuBar::on_item_selected);
	...
	check_item2.func_clicked() = bind_member(this, &MenuBar::on_item_selected);
	...
	check_item3.func_clicked() = bind_member(this, &MenuBar::on_item_selected);
	...
	check_item4.func_clicked() = bind_member(this, &MenuBar::on_item_selected);
