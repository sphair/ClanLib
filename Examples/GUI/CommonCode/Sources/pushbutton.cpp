	...
	clan::Window(&manager, clan::GUITopLevelDescription("PushButton", clan::Rect(256 + 16, 256 + 16, clan::Size(256, 180)), false))
{
	...
	pushbutton1->func_clicked() = bind_member(this, &PushButton::on_clicked, pushbutton1);
	...
	checkbox_icon->func_checked() = bind_member(this, &PushButton::on_checked_icon, checkbox_icon);
	checkbox_icon->func_unchecked() = bind_member(this, &PushButton::on_unchecked_icon, checkbox_icon);
	...
	checkbox_toggle->func_checked() = bind_member(this, &PushButton::on_checked_toggle, checkbox_toggle);
	checkbox_toggle->func_unchecked() = bind_member(this, &PushButton::on_unchecked_toggle, checkbox_toggle);
	...
	checkbox_disable->func_checked() = bind_member(this, &PushButton::on_checked_disable, checkbox_disable);
	checkbox_disable->func_unchecked() = bind_member(this, &PushButton::on_unchecked_disable, checkbox_disable);
