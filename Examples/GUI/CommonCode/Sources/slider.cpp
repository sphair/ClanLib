	...
	clan::Window(&manager, clan::GUITopLevelDescription("Slider", clan::Rect(256 + 16, 8, clan::Size(256, 256)), false))
{
	...
	slider_vertical->func_value_changed() = bind_member(this, &Slider::on_value_changed, slider_vertical);
	slider_vertical->func_value_decremented() = bind_member(this, &Slider::on_value_decremented, slider_vertical);
	slider_vertical->func_value_incremented() = bind_member(this, &Slider::on_value_incremented, slider_vertical);
	slider_vertical->func_slider_moved() = bind_member(this, &Slider::on_slider_moved, slider_vertical);
	...
	slider_horizontal->func_value_changed() = bind_member(this, &Slider::on_value_changed, slider_horizontal);
	slider_horizontal->func_value_decremented() = bind_member(this, &Slider::on_value_decremented, slider_horizontal);
	slider_horizontal->func_value_incremented() = bind_member(this, &Slider::on_value_incremented, slider_horizontal);
	slider_horizontal->func_slider_moved() = bind_member(this, &Slider::on_slider_moved, slider_horizontal);
	...
	lineedit_min->func_enter_pressed() = bind_member(this, &Slider::on_min_enter_pressed, lineedit_min);
	...
	lineedit_max->func_enter_pressed() = bind_member(this, &Slider::on_max_enter_pressed, lineedit_max);
	...
	lineedit_tick_count->func_enter_pressed() = bind_member(this, &Slider::on_tick_count_enter_pressed, lineedit_tick_count);
	...
	lineedit_page_step->func_enter_pressed() = bind_member(this, &Slider::on_page_step_enter_pressed, lineedit_page_step);
	...
	lineedit_position_vert->func_enter_pressed() = bind_member(this, &Slider::on_position_enter_pressed_vert, lineedit_position_vert);
	...
	lineedit_position_horiz->func_enter_pressed() = bind_member(this, &Slider::on_position_enter_pressed_horiz, lineedit_position_horiz);
	...
	pushbutton_apply->func_clicked() = bind_member(this, &Slider::on_apply_clicked, pushbutton_apply);
	...
	checkbox_lock_to_ticks->func_checked() = bind_member(this, &Slider::on_checked_lock_to_ticks, checkbox_lock_to_ticks);
	checkbox_lock_to_ticks->func_unchecked() = bind_member(this, &Slider::on_unchecked_lock_to_ticks, checkbox_lock_to_ticks);
	...
	checkbox_disable->func_checked() = bind_member(this, &Slider::on_checked_disable, checkbox_disable);
	checkbox_disable->func_unchecked() = bind_member(this, &Slider::on_unchecked_disable, checkbox_disable);
