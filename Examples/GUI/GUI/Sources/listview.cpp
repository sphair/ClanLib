	...
	gui(gui)
{
	...
	{
		sprite_mycomputer = CL_Sprite(gc, "Resources/tux.png");
		sprite_folder = CL_Sprite(gc, "Resources/tux.png");
		sprite_overlay = CL_Sprite(gc, "Resources/tux.png");
	}

	toolbar = new CL_ToolBar(this);
	toolbar->set_geometry(CL_Rect(client_area.left, client_area.top, CL_Size(32, 180)));
	toolbar->add_item(CL_Sprite(gc, "Resources/tux.png"), 0, "Tux1", 0);
	toolbar->add_item(CL_Sprite(gc, "Resources/tux.png"), 0, "Tux2", 0);
