...
class ComboBox : public CL_Window
{
public:
	ComboBox(GUI *gui);

private:
	void on_dropdown_opened(CL_ComboBox *combobox);
	...
	void on_checked_editable(CL_CheckBox *checkbox);
	void on_unchecked_editable(CL_CheckBox *checkbox);

private:
	GUI *gui;

	CL_ComboBox *combobox1;
	CL_PopupMenu menu;

	CL_Label *label_disable;
	CL_CheckBox *checkbox_disable;

	CL_Label *label_editable;
	CL_CheckBox *checkbox_editable;
