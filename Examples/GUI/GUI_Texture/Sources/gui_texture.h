...
private:
	...
	clan::GUIWindowManagerTexture wm;
	 ...
	 std::unique_ptr<PushButton> pushbutton;
	 std::unique_ptr<LineEdit> lineedit;
	 std::unique_ptr<CheckBox> checkbox;
	 std::unique_ptr<Slider> slider;
	 std::unique_ptr<RadioButton> radiobutton;
	 std::unique_ptr<ProgressBar> progressbar;
	 std::unique_ptr<TabPage> tabpage;
	 std::unique_ptr<MenuBar> menubar;
	 std::unique_ptr<Spin> spin;
	 std::unique_ptr<ComboBox> combobox;
	 std::unique_ptr<ListView> listview;
	 std::unique_ptr<Theme> window_theme;
