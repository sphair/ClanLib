...
bool GUI::run()
{
	...
	fps_font.draw_text(gc, gc.get_width() - 100, 24, fps, CL_Colorf(4.0f, 4.0f, 1.0f, 1.0f));

	fps_font.draw_text(gc, 24, gc.get_height() - 48, "Rendering GUI onto a CL_Texture, then onto the layered OpenGL window.",  CL_Colorf(4.0f, 4.0f, 1.0f, 1.0f));
