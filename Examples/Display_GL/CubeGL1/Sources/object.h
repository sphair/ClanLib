...
public:
	...
	clan::Vec3f m_OriginalPoint;
	clan::Vec3f m_Point;
	clan::Vec3f m_TexturePoint;
...
public:
	...
	void Draw(clan::GraphicContext &gc, clan::Texture &texture_image);
	void CalcNormal();
...
public:
	...
	void Draw(clan::GraphicContext_GL1 &gc, clan::Texture &texture_image);
