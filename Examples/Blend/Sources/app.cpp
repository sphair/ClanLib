...
int App::start(const std::vector<CL_String> &args)
{
	try
	{
		...
		win_desc.set_size(CL_Size( 900, 550 ), false);
		...
		CL_ResourceManager resources_gui(resource_filename);
		...
		CL_PixelBuffer pbuff_ball("Resources/ball.png");
		pbuff_ball.premultiply_alpha();
		CL_Image image_ball_premultiply_alpha(gc, pbuff_ball);
