...
void Options::on_mapmode_selected(int value, CL_ComboBox *combo)
{
	switch (value)
	{
		case 0:
...
void Options::slider_grid_angle_changed()
{
	...
	CL_String text(cl_format("Grid Rotation : %1 (user projection)", grid_angle));
...
CL_ComboBox *Options::create_mapmode_combo_box(int xpos, int ypos, CL_PopupMenu &menu, int selected_item)
{
...
void Options::make_mapmode_menu(CL_PopupMenu &menu)
{
