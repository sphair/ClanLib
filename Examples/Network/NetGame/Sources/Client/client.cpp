...
Client::Client()
{
	...
	cc.connect(network_client.sig_event_received(), {this, &Client::on_event_received});
	cc.connect(network_client.sig_connected(), {this, &Client::on_connected});
	cc.connect(network_client.sig_disconnected(), {this, &Client::on_disconnected});
