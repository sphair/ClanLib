...
{
public:
	ParticleObject(GraphicContext &gc, Scene &scene_owner, SceneObject *parent_object);
...
private:
	...
	VertexArrayBuffer object_positions_vbo;
	VertexArrayBuffer object_colours_vbo;
};
