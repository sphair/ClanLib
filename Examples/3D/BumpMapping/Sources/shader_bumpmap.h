...
{
public:
	ShaderBumpMap(CL_GraphicContext &gc);
	...
	void SetLight(CL_Vec3f &new_light_vector, CL_Vec4f &new_light_specular, CL_Vec4f &new_light_diffuse, CL_Vec4f &new_light_ambient);
private:
