...
char ShaderBumpMap::fragment[] =
	...
	"	vec3 normal_map = texture2D(Texture1, TexCoord0.xy).rgb;\n"
...
ShaderBumpMap::ShaderBumpMap(GraphicContext &gc)
{
...
void ShaderBumpMap::Use(GraphicContext &gc)
{
	if (!material_updated)
	{
...
void ShaderBumpMap::SetMaterial(float new_material_shininess, const Vec4f &new_material_emission, const Vec4f &new_material_ambient, const Vec4f &new_material_specular)
{
...
void ShaderBumpMap::SetLight(Vec3f &new_light_vector, Vec4f &new_light_specular, Vec4f &new_light_diffuse, Vec4f &new_light_ambient)
{
