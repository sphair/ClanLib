...
public:
	...
	void Load(GraphicContext &gc, GraphicStore *gs, const char *filename, bool we_do_not_want_texures_on_this_object);

	void Draw(GraphicContext &gc, GraphicStore *gs, const Mat4f &modelview_matrix, bool is_draw_shadow);
...
Model::Model(GraphicContext &gc, GraphicStore *gs, const char *filename, bool we_do_not_want_texures_on_this_object): impl(new Model_Impl())
{
	impl->Load(gc, gs, filename, we_do_not_want_texures_on_this_object);
}
...
void Model::Draw(GraphicContext &gc, GraphicStore *gs, const Mat4f &modelview_matrix, bool is_draw_shadow)
{
...
void Model_Impl::Load(GraphicContext &gc, GraphicStore *gs, const char *filename, bool we_do_not_want_texures_on_this_object)
{
...
void Model_Impl::Draw(GraphicContext &gc, GraphicStore *gs, const Mat4f &modelview_matrix, bool is_draw_shadow)
{
