...
private:
	void render_from_lightsource(CL_GraphicContext &gc, CL_FrameBuffer &framebuffer);
	void render_from_camera(CL_GraphicContext &gc, CL_FrameBuffer &framebuffer);
