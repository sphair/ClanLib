...
public:
	...
	void Load(CL_GraphicContext &gc, GraphicStore *gs, const char *filename, bool we_do_not_want_texures_on_this_object);
...
Model::Model(CL_GraphicContext &gc, GraphicStore *gs, const char *filename, bool we_do_not_want_texures_on_this_object): impl(new Model_Impl())
{
...
void Model_Impl::Load(CL_GraphicContext &gc, GraphicStore *gs, const char *filename, bool we_do_not_want_texures_on_this_object)
{
