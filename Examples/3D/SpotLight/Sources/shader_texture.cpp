...
void ShaderTexture::SetSpotLight(const Vec3f &new_light_position, const Vec3f &new_light_direction, Vec4f &new_light_specular, Vec4f &new_light_diffuse, float new_spot_exponent, float new_spot_cutoff)
{
