...
void ShaderColor::Use(GraphicContext &gc)
{
	...
	if (!spot_light_updated)
	{
		...
		float cos_cutoff = cos(spot_light_cutoff * PI / 180.0f);
...
void ShaderColor::SetLight(Vec3f &new_light_vector, Vec4f &new_light_specular, Vec4f &new_light_diffuse)
{
...
void ShaderColor::SetSpotLight(const Vec3f &new_light_position, const Vec3f &new_light_direction, Vec4f &new_light_specular, Vec4f &new_light_diffuse, float new_spot_exponent, float new_spot_cutoff)
{
