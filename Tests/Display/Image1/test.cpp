...
public:
	int start(const std::vector<std::string> &args)
	{
		...
		try
		{
			...
			Texture texture(gc, "Images/square.png");
			...
			while((!quit) && (!window.get_ic().get_keyboard().get_keycode(KEY_ESCAPE)))
			{
				...
				image_texture.draw(gc, Rect(32, 0, Size(32, 32)), Rect(150, 200, Size(32, 32)));
				...
				image_texture.draw(gc, Rect(32, 32, Size(32, 32)), Rect(450, 200, Size(32, 32)));
				...
				image_bottom_right.draw(gc, Rect(150, 300, Size(128, 256)));
				...
				Draw::circle(gc, 450+offset, 500+offset, 4, Colorf(1.0f, 1.0f, 1.0f, 0.9f));
				...
				Draw::circle(gc, 700+offset, 500+offset, 4, Colorf(1.0f, 1.0f, 1.0f, 0.9f));
				...
				Draw::circle(gc, 700+offset, 200+offset, 4, Colorf(1.0f, 1.0f, 1.0f, 0.9f));
