...
private:
	...
	void draw_equal_tex_equal_sprites(Canvas &canvas, int sprite_count, int time_elapsed);
	void draw_equal_tex_diff_sprites(Canvas &canvas, int sprite_count, int time_elapsed);
	void draw_equal_tex_diff_sprites_batch(Canvas &canvas, int sprite_count, int time_elapsed);

	void draw_diff_tex_diff_sprites(Canvas &canvas, int sprite_count, int time_elapsed);
	void draw_diff_tex_diff_sprites_batch(Canvas &canvas, int sprite_count, int time_elapsed);
...
// This is the Program class that is called by ClanApplication
class Program
{
public:
...
int App::start(const std::vector<std::string> &args)
{
	...
	try
	{
		...
		explosion1 = Sprite(canvas, "Explosion1", &resources);
		explosion2 = Sprite(canvas, "Explosion2", &resources);
...
void App::draw_equal_tex_equal_sprites(Canvas &canvas, int sprite_count, int time_elapsed)
{
	int count = 0;
	for(int x=0; x<100; ++x)
	{
...
void App::draw_equal_tex_diff_sprites(Canvas &canvas, int sprite_count, int time_elapsed)
{
	int count = 0;
	for(int x=0; x<100; ++x)
	{
...
void App::draw_equal_tex_diff_sprites_batch(Canvas &canvas, int sprite_count, int time_elapsed)
{
	// Batching is builtin in 2.0..
	draw_equal_tex_diff_sprites(canvas, sprite_count, time_elapsed);
}

void App::draw_diff_tex_diff_sprites(Canvas &canvas, int sprite_count, int time_elapsed)
{
	int count = 0;
	for(int x=0; x<100; ++x)
	{
...
void App::draw_diff_tex_diff_sprites_batch(Canvas &canvas, int sprite_count, int time_elapsed)
{
	// Batching is builtin in 2.0..
