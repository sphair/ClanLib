...
//			gui.set_css_document("../../../Resources/GUIStyleMirage/theme.css");
			...
			win_desc.set_title("Themes Test Application");

			CL_GUITopLevelDescription window_desc1;
			CL_Window window1(CL_Rect(10, 10, 510, 410), &gui, window_desc1);

			CL_GUITopLevelDescription window_desc;
			CL_Window window(CL_Rect(50, 50, 540, 440), &gui, window_desc);
			window.func_close().set(this, &App::on_close, &window);

			CL_Rect client_area_pos = window.get_client_area();
