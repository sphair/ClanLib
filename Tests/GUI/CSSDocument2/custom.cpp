...
void Custom::on_render(Canvas &canvas, const Rect &update_rect)
{
	...
	canvas.fill(text3_rect, Colorf(0.5f, 0.5f, 0.5f, 0.5f));
	...
	canvas.box(rendered_text1_rect, Colorf(0.5f, 0.5f, 0.5f, 1.0f));
	canvas.box(rendered_text2_rect, Colorf(0.5f, 0.5f, 0.5f, 1.0f));
	canvas.box(rendered_text3_rect, Colorf(0.5f, 0.5f, 0.5f, 1.0f));
