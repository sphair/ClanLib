...
{
	CL_Console::write_line(" Header: sha512_224.h");
	CL_Console::write_line("  Class: CL_SHA512_224");

	// Using http://csrc.nist.gov/groups/ST/toolkit/documents/Examples/SHA512_224.pdf for test data

	CL_SHA512_224 sha512_224;
...
void TestApp::test_hash(const CL_SHA512_224 &sha512_224, const char *hash_text)
{
	CL_String8 hash = sha512_224.get_hash(true);
	if (hash != hash_text)
		fail();
