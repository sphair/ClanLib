...
: GUIComponent(parent)
{
	...
	theme_part = GUIThemePart(this);
}

void ViewBorder::on_resized()
{
	Rect content_area = theme_part.get_content_box(Rect(Point(0, 0), get_geometry().get_size()));
...
void ViewBorder::on_render(GraphicContext &gc, const Rect &update_rect)
{
