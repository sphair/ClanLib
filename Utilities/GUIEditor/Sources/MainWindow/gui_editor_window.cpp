...
: Window(gui_manager, get_startup_description()),
...
void GuiEditorWindow::populate_tools_toolbar(ResourceManager &resources)
{
	...
	Sprite sprite(get_gc(), "Pointer", &resources);
	...
	{
		Sprite sprite(get_gc(), types[index]->resource_icon, &resources);
...
void GuiEditorWindow::populate_main_toolbar(ResourceManager &resources)
{
	...
	toolbar_main->insert_item(Sprite(get_gc(), "ToolbarNew", &resources), 0, "New", main_toolbar_new);
	toolbar_main->insert_item(Sprite(get_gc(), "ToolbarOpen", &resources), 0, "Open", main_toolbar_open);
	toolbar_main->insert_item(Sprite(get_gc(), "ToolbarSaveAs", &resources), 0, "Save As", main_toolbar_saveas);
	toolbar_main->insert_item(Sprite(get_gc(), "ToolbarSave", &resources), 0, "Save", main_toolbar_save);
}
...
void GuiEditorWindow::on_process_messages(GUIMessage &msg)
{
