...
bool PropertyComponentEditState::on_input_pressed(const InputEvent &input_event)
{
	if (state == state_none)
	{
...
bool PropertyComponentEditState::on_input_released(const InputEvent &input_event)
{
	return edit_state_handlers[state]->on_input_released(input_event);
}

bool PropertyComponentEditState::on_input_doubleclick(const InputEvent &input_event)
{
	return edit_state_handlers[state]->on_input_doubleclick(input_event);
}

bool PropertyComponentEditState::on_input_pointer_moved(const InputEvent &input_event)
{
