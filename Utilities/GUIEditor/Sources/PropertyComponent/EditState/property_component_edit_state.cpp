...
void PropertyComponentEditState::set_pseudo_class(State new_state)
{
	state = new_state;
}

bool PropertyComponentEditState::on_input_pressed(const clan::InputEvent &input_event)
{
	if (state == state_none)
	{
...
bool PropertyComponentEditState::on_input_released(const clan::InputEvent &input_event)
{
	return edit_state_handlers[state]->on_input_released(input_event);
}

bool PropertyComponentEditState::on_input_doubleclick(const clan::InputEvent &input_event)
{
	return edit_state_handlers[state]->on_input_doubleclick(input_event);
}

bool PropertyComponentEditState::on_input_pointer_moved(const clan::InputEvent &input_event)
{
