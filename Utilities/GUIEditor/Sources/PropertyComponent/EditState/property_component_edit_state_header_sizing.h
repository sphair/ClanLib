...
#include "property_component_edit_state_handler.h"

class PropertyComponentEditStateHeaderSizing : public PropertyComponentEditStateHandler
{
public:
	PropertyComponentEditStateHeaderSizing();
