...
bool GridEditStateBoundarySizing::on_input_pressed(const CL_InputEvent &e)
{
...
bool GridEditStateBoundarySizing::on_input_released(const CL_InputEvent &e)
{
	if (e.id == CL_MOUSE_LEFT)
	{
...
bool GridEditStateBoundarySizing::on_input_doubleclick(const CL_InputEvent &e)
{
	return false;
}
